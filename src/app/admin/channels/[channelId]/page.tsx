            ...
            <div className="p-5 rounded-xl border border-border bg-surface-elevated space-y-4">
              ...
              <div className="space-y-3">
                ...
                <button
                  ...
                  className="w-full px-4 py-2 bg-accent text-background text-sm font-medium rounded-lg hover:bg-accent-hover disabled:opacity-40 transition-colors"
                >
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="px-4 py-2 bg-surface-elevated border border-border text-foreground text-sm font-medium rounded-lg hover:border-accent/40 transition-colors"
              >
                Batch Order
              </button>
              <button
                onClick={() => setShowCreateDialog(true)}
                className="px-4 py-2 bg-accent text-background text-sm font-medium rounded-lg hover:bg-accent-hover transition-colors"
              >
                New Carousel
              </button>
            </div>
