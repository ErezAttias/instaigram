...
export function ChannelCard({
  ...
  const displayName = name === 'Untitled Channel' && niche ? niche : name;
  const showNiche = name !== 'Untitled Channel' && niche;
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        {showNiche && (
          <p className="text-xs text-muted mt-0.5 truncate">{niche}</p>
        )}
      </div>
